...
def main():
    ...
    st.markdown("**Composite Modulus of Subgrade Reaction ตามวิธี AASHTO 1993 // พัฒนาโดย รศ.ดร.อิทธิพล มีผล // ภาควิชาครุศาสตร์โยธา มจพ.**")
        ...
        if uploaded_file is not None:
            ...
            with st.sidebar.expander("2️⃣ ค่าพารามิเตอร์ (ตำแหน่งสี่เหลี่ยม)", expanded=True):
                ...
                start_x = st.slider(
                    ...
                    help="12inch ใช้เลข249, 13inch-269,14inch-207,15-228,16-169,18 inch-128"
                )
